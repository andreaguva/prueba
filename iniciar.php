...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <div class="col-md-10 mx-auto col-lg-5">
            ...
            <form action= "./controller/login.php" method="POST" class="was-validated p-4 p-md-5 border rounded-3 bg-light">
        ...
        <div class="d-grid m-0 ">
                    ...
                    <button type="button" class="btn btn-secondary ">
                         <a type="submit" href="http://localhost/sitioweb/administrador/index.php">
                            ...
                            <!-- <a type="submit" class="btn btn-secondary ms-4 me-4" href="../config/config.php">
