...
<ol class="breadcrumb">
  <li><a href="?c=usuarioCliente">Clientes</a></li>
  <li class="active"><?php echo $clie->id != null ? $clie->nombreCliente : 'Nuevo Registro'; ?></li>
</ol>

<form id="frm-usuarioCliente" action="?c=Cliente&a=Guardar" method="post" enctype="multipart/form-data">
...
<script>
    $(document).ready(function(){
        $("#frm-usuarioCliente").submit(function(){
